...
export const LIBRARY_RESOURCES: LibraryResource[] = [
  ...
  {
    id: "founders-pocket-guide-seed-fundraising",
    kind: "infographic",
    title: "Founder's Pocket Guide · Seed Fundraising",
    source: "Black Dog VP",
    blurb:
      "Single-page reference for the seed-stage round. Sequence, target check sizes, instrument types, and the operator timeline from term sheet to close.",
    fileUrl: "/resources/founders-pocket-guide-seed-fundraising.jpg",
    rubricDims: ["businessModel", "tractionQuality", "riskSurface"],
    journeyStages: [1, 2, 3, 4],
    coverEyebrow: "INFOGRAPHIC · POCKET GUIDE",
    coverTitle: "Seed Fundraising",
    coverAccent: "gold",
  },
  {
    id: "startup-pitch-canvas",
    kind: "infographic",
    title: "The Startup Pitch Canvas",
    source: "Black Dog VP",
    blurb:
      "One-page canvas for organizing a pitch before the deck. Problem · audience · solution · why-now · why-you · ask. Use it as the outline before slide one.",
    fileUrl: "/resources/startup-pitch-canvas.jpg",
    rubricDims: ["wedgeClarity", "deckQuality", "whyNow"],
    journeyStages: [1, 2, 3],
    coverEyebrow: "INFOGRAPHIC · CANVAS",
    coverTitle: "Pitch Canvas",
    coverAccent: "green",
  },
  {
    id: "startup-metrics",
    ...
    source: "Black Dog VP",
    blurb:
      "The numbers partners price companies on. ARR, NRR, gross margin, burn multiple, payback, magic number — what each means and where small-n founders go wrong reporting them.",
    fileUrl: "/resources/startup-metrics.jpg",
    rubricDims: ["tractionQuality", "businessModel"],
    journeyStages: [2, 3, 4],
    coverEyebrow: "INFOGRAPHIC · METRICS",
    coverTitle: "Startup Metrics",
    coverAccent: "sage",
  },
  {
    id: "top-18-kpis-for-ceos",
    kind: "infographic",
    title: "Top 18 KPIs for CEOs",
    source: "Black Dog VP",
    blurb:
      "Operator-CEO instrument panel. The eighteen numbers Scott expects in a CEO's monthly update — pipeline, retention, runway, headcount efficiency, sales cycle, customer concentration.",
    fileUrl: "/resources/top-18-kpis-for-ceos.jpg",
    rubricDims: ["tractionQuality", "gtmRepeatability"],
    journeyStages: [3, 4, 5],
    coverEyebrow: "INFOGRAPHIC · OPERATOR",
    coverTitle: "CEO KPIs",
    coverAccent: "gold",
  },
];
